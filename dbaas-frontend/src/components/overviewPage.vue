...
export default {
  ...
  methods: {
    ...
    deleteCluster() {
      ...
      axios.post("http://172.16.1.97:8000/api/v2/deletecluster/", formData)
        .then(response => {
  ...
  getClusterDetails() {
    axios.get(`http://172.16.1.97:8000/api/v2/result/content/${this.selectedCluster}/`)
      .then(response => {
  ...
  fetchProjects() {
    axios.get(`http://172.16.1.97:8000/api/v2/project/user/${this.user_id}/`)
      .then(response => {
  ...
  fetchClusters() {
    axios.get(`http://172.16.1.97:8000/api/v2/cluster/user/${this.user_id}/`)
      .then(response => {
  ...
  fetchClustersByProject() {
    if (this.selectedProject) {
      axios.get(`http://172.16.1.97:8000/api/v2/cluster/project/${this.selectedProject}/`)
        .then(response => {
          this.clusters = response.data;
        });
    } else {
