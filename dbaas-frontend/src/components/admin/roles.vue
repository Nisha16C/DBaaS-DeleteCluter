...
export default {
    ...
    methods: {
        ...
        async fetchUserRoles() {
            try {
                const response = await axios.get(
                    `http://172.16.1.97:8000/api/v1/users/${this.userId}/roles/`
                );
        ...
        async fetchUserDetails() {
            ...
            try {
                const response = await axios.get(`http://172.16.1.97:8000/api/v1/users/${this.userId}/`);
        ...
        async handleAssignRoles(selectedRoles) {
            ...
            try {
                const response = await axios.post(`http://172.16.1.97:8000/api/v1/add_roles_to_user/`, {
                    user_id: this.userId,
                    roles: selectedRoles,
                });
