...
urlpatterns = [
    ...
    # Correct import for destroy_cluster
    path('api/v2/cluster/destroy_cluster/', ClusterViewSet.as_view({'post': 'destroy_cluster'}), name='destroy_cluster'),
    # path('api/v2/cluster/<str:cluster_name>/destroy_pipeline/', ClusterViewSet.as_view({'post': 'destroy_pipeline'}), name='destroy_pipeline'),
    # path('api/v2/cluster/destroy_cluster/${clusterId}/', ClusterViewSet.as_view({'post': 'destroy_cluster'}), name='destroy_cluster'),
